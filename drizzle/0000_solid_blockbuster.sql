...
CREATE TABLE `chat_sessions` (
	...
	`call_offered` integer DEFAULT false,
	`voice_token` text
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `workspace_assets_type_idx` ON `workspace_assets` (`asset_type`);--> statement-breakpoint
CREATE INDEX `workspace_assets_run_idx` ON `workspace_assets` (`process_run_id`);