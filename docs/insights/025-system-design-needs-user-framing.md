...
- This same pattern will apply within Ditto itself: when the platform helps users define processes (Explore mode), it must frame the conversation from the user's perspective, not the system's capabilities.
