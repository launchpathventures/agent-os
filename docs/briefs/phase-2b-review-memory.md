...
- **Depends on:** Phase 2a (pipeline skeleton + trust gate)
- **Unlocks:** Phase 2c (parallel execution), Phase 3 (trust earning — with memory data)
...
Parent design: `docs/briefs/phase-2-harness.md` (sections 3, 4, 8 — memory schema).
...
1. `docs/briefs/phase-2-harness.md` — parent design (sections 3, 4, 8)
