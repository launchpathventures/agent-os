...
- **Unlocks:** Phase 2b (review patterns + memory), Phase 2c (parallel execution)
...
Parent design: `docs/briefs/phase-2-harness.md` (full Phase 2 design). This sub-brief extracts sections 1, 2, 6, and 7.
...
1. `docs/briefs/phase-2-harness.md` — parent design (sections 1, 2, 6, 7)
