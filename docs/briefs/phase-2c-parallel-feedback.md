...
- **Depends on:** Phase 2a (pipeline + heartbeat rewrite), Phase 2b (review patterns — needed for parallel steps to have review layers)
- **Unlocks:** Phase 3 (trust earning — all harness data now available)
...
Parent design: `docs/briefs/phase-2-harness.md` (section 5, plus depends_on parts of section 7).
...
1. `docs/briefs/phase-2-harness.md` — parent design (section 5)
