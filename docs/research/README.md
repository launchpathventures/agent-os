...
| `phase-10-dashboard-workspace.md` | Phase 10 Web Dashboard: AI workspace UIs (10 products), HITL oversight UX (trust/autonomy/review), process visualization (Temporal/Inngest/n8n), streaming (AG-UI), tech stack (Next.js/shadcn/AI SDK/ReactFlow). 5 cross-cutting patterns, 5 Ditto-original gaps. | 2026-03-23 | Active | Phase 10 MVP brief, Dev Architect, Dev Designer |
