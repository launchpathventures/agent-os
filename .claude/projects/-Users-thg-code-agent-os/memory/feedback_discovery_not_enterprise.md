---
name: Discovery is practical data ingestion, not enterprise process mining
description: Process discovery must focus on ingesting readily available data (email, calendar, docs, Slack, service desk) — not enterprise process mining approaches
type: feedback
---
...
**How to apply:** When designing or researching process discovery, lead with "what common data sources can we connect to?" not "how do enterprise process mining tools work?" Keep the enterprise landscape as context/comparison only.
